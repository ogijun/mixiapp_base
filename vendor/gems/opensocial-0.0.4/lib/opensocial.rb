...
require 'opensocial/album'
require 'opensocial/media'
require 'opensocial/notification'
require 'opensocial/messaging'
require 'opensocial/statusmood'
require 'opensocial/profilecomment'
require 'opensocial/statusmoodcomment'
